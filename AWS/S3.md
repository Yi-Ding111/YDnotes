...
## Use boto3 read object modified time into s3
...
## Use boto3 sort s3 objects by write-in time 
...
## Send event notification when objects in s3 have operations

Event types: https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-how-to-event-types-and-destinations.html

### Lambda

The event notification from s3 event notification to lambda would be like:
...
S3 will be as a trigger for lambda and we could get information about objects.

Here is one examle when put a new object into s3, and lambda will be triggered
...
def lambda_handler(event, context):
    ...
    print('bucket: ', bucket)
		...
		# get the s3 key of the new object be placed
    print(event['Records'][0]['s3']['object']['key'])
		
    # decode the s3 key of the new object
